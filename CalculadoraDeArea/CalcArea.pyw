...
janela.title("Calculadora de Área")# titulo_do_programa
photo = PhotoImage(file ='icon.png')# icone_do_programa
...
convert_de = Label(container_02_op_1, bg=back_ground, relief=FLAT,fg=cor_fonte, text='converter de', width=20, font=('DejaVu Sans Mono', 10))
convert_de.pack()
container_02_op_2 = Frame(container_02, bg=back_ground, padx=10)
container_02_op_2.pack()
bt_ha = Button(container_02_op_2,bg=back_ground, fg=cor_fonte, text='ha', font='Arial 10', width=3, command=bt_ha)
bt_ha.pack(side=LEFT)
bt_alq = Button(container_02_op_2,bg=back_ground, fg=cor_fonte, text='Alq', font='Arial 10', width=3, command=bt_alq)
bt_alq.pack(side=LEFT)
bt_m2 = Button(container_02_op_2, bg=back_ground, fg=cor_fonte, text='M²', font='Arial 10', width=3, command=bt_m2)
...
container_03e.pack()
#-------------------Teclado Numerico--------------------
bt_01 = Button(container_03c, text='1',bg=back_ground, fg=cor_fonte,font='Arial 12', width=3, command=bt_01)
bt_01.pack(side=LEFT)
bt_02 = Button(container_03c, text='2',bg=back_ground, fg=cor_fonte,font='Arial 12', width=3, command=bt_02)
bt_02.pack(side=LEFT)
bt_03 = Button(container_03c, text='3',bg=back_ground, fg=cor_fonte,font='Arial 12', width=3, command=bt_03)
bt_03.pack(side=LEFT)
bt_04 = Button(container_03b, text='4',bg=back_ground, fg=cor_fonte,font='Arial 12', width=3, command=bt_04)
bt_04.pack(side=LEFT)
bt_05 = Button(container_03b, text='5',bg=back_ground, fg=cor_fonte,font='Arial 12', width=3, command=bt_05)
bt_05.pack(side=LEFT)
bt_06 = Button(container_03b, text='6',bg=back_ground, fg=cor_fonte,font='Arial 12', width=3, command=bt_06)
bt_06.pack(side=LEFT)
bt_07 = Button(container_03a, text='7',bg=back_ground, fg=cor_fonte,font='Arial 12', width=3, command=bt_07)
bt_07.pack(side=LEFT)
bt_08 = Button(container_03a, text='8',bg=back_ground, fg=cor_fonte,font='Arial 12', width=3, command=bt_08)
bt_08.pack(side=LEFT)
bt_09 = Button(container_03a, text='9',bg=back_ground, fg=cor_fonte,font='Arial 12', width=3, command=bt_09)
